...
// src/ffapl.js
var ffapl_exports = {};
__export(ffapl_exports, {
  FFapl: () => FFapl,
  FFaplLanguage: () => FFaplLanguage
});
module.exports = __toCommonJS(ffapl_exports);
...
var highlight = (0, import_highlight.styleTags)({
  "program procedure function const": import_highlight.tags.definitionKeyword,
  "to step new": import_highlight.tags.operatorKeyword,
  "for while if else return break": import_highlight.tags.controlKeyword,
  ...
  PrimitiveType: import_highlight.tags.standard(import_highlight.tags.typeName),
  Identifier: import_highlight.tags.variableName,
  "ProcFuncCall/Identifier": import_highlight.tags.function(import_highlight.tags.variableName),
  "Program/Identifier Procedure/Identifier Function/Identifier": import_highlight.tags.function(import_highlight.tags.definition(import_highlight.tags.variableName)),
  ...
  "Equals AssignOp": import_highlight.tags.definitionOperator,
...
var parser = import_lr.LRParser.deserialize({
  ...
  tokenizers: [1, 2, 3, 4, new import_lr.LocalTokenGroup("j~RQYZXz{^~^O$P~~aP!P!Qd~iO$Q~~", 25, 138)],
...
// src/ffapl.js
var FFaplLanguage = import_language.LRLanguage.define({
  name: "FFapl",
  parser: parser.configure({
    props: [
      import_language2.indentNodeProp.add({
        Block: (0, import_language2.delimitedIndent)({ closing: "}" }),
        FuncBlock: (0, import_language2.delimitedIndent)({ closing: "}" }),
        ProgramBlock: (0, import_language2.delimitedIndent)({ closing: "}" }),
        ConstDecl: (0, import_language2.continuedIndent)({ except: /^{/ }),
        Decl: (0, import_language2.continuedIndent)({ except: /^{/ }),
        Statement: (0, import_language2.continuedIndent)({ except: /^{/ })
      })
    ]
  }),
  languageData: {
...
function FFapl() {
  return new import_language.LanguageSupport(FFaplLanguage, []);
}
